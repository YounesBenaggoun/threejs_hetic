...
export default class Sol {
    ...
    createGround() {
        ...
        const colorMap = loader.load('/public/sol/sol_color.jpg');
        const normalMap = loader.load('/public/sol/sol_normal.jpg');
        const roughnessMap = loader.load('/public/sol/sol_roughness.jpg');
    ...
    createGrass() {
        const loader = new THREE.TextureLoader();
        const grassTexture = loader.load('/public/grass/grass.png');
        ...
        for (let i = 0; i < COUNT; i++) {
            ...
            const y = this.getHeightAt(x, z) + 0.2;
